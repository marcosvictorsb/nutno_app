                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                    ...
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            ...
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Encontre respostas para as dúvidas comuns.</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">Central de Suporte</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Acesse nossa central de ajuda e documentação.</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">Gestor de Permissões</span>
                            <span class="text-surface-600 dark:text-surface-200 lg:text-xl">Gerencie suas permissões de acesso.</span>
                        </span>
                    </router-link>
                    <Button as="router-link" label="Voltar para Login" to="/auth/login" />
                </div>
            </div>
        </div>
    </div>
